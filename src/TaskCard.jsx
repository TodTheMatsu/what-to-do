    ...
    return (
        ...
        >
            ...
            <div onClick={deleteTask}
                 className="bg-red-500 select-none hover:bg-red-700 text-white font-bold py-1 px-2 rounded-full text-sm absolute -top-2 -right-2 border-2 border-red-700 cursor-pointer">
                X
            </div>
        </div>
    );
