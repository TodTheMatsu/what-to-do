function TaskCard({ text, provided, deleteTask}) {
    return (
        <div
            className="w-full h-20 my-2 hover:bg-gray-300 bg-gray-100 shadow-2xl border-2 border-gray-400 rounded-md flex items-center justify-center flex-col relative hover:border-gray-900"
