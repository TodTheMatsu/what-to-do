        ...
        <>
            ...
            <div className="z-30 w-[600px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-300 h-4/6 rounded-lg shadow-lg border-8 border-gray-300 bg-gradient-to-br from-gray-100 to-gray-200 shadow-gray-500">
                {taskObj && (
                    <>
                        <input
                            className="z-30 w-[500px] text-3xl font-bold tracking-tight bg-transparent text-gray-900 text-left mx-10 my-5 focus:outline-none focus:bg-gray-200 hover:bg-gray-200"
                            value={taskObj.name}
                            onChange={handleInputChange}
                            placeholder='Enter a task...'
                        />
                        <div className="z-30 overflow-auto max-h-[85%] bg-slate-200 rounded-sm mx-5 shadow-2xl">
                            <textarea
